#!/usr/bin/env python3
"""Read-only board-contract audit for ESP-IDF projects.
...
def _audit_pin_facts(
    ...
    if checked == 0:
        report.add(
            ...
            "No recognizable board-pin declarations were found; "
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Audit an ESP-IDF project against the board contract."
    )
